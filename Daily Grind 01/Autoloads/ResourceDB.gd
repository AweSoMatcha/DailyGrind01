...
onready var _characters := _load_resources("res://Assets/Characters/", "_is_character")
onready var _backgrounds := _load_resources("res://Assets/Backstage/", "_is_background")
